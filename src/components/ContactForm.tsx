  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-2xl">
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div>
          <label htmlFor="cf-name" className="label-type text-muted-foreground">
            Name
          </label>
          <input
            id="cf-name"
        ...
        <div>
          <label htmlFor="cf-email" className="label-type text-muted-foreground">
            Email
          </label>
          <input
            id="cf-email"
      ...
      <div className="mt-6">
        <label htmlFor="cf-message" className="label-type text-muted-foreground">
          Message
        </label>
        <textarea
          id="cf-message"
      ...
      >
        <span className="label-type">Send message</span>
      </button>
    </form>
  );
}
