      ...
      <section className="border-b border-foreground pb-8 pt-6 md:pb-10 md:pt-8">
        <Container>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_19rem] lg:items-end lg:gap-12">
            <div>
              <p className="mono-type text-accent">[ {site.role} ]</p>
              <h1 className="display-type mt-4 text-[14vw] uppercase leading-[0.84] md:text-[9vw] lg:text-[6.4rem]">
                candela sol
                <br />
              ...
              <div className="mt-7 flex flex-wrap gap-x-5 gap-y-2">
                ...
                {site.socials.map((s) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="mono-type text-foreground/70 transition-colors hover:text-accent"
                  >
                    {s.label}
                  </a>
                ))}
      ...
      <section className="border-b border-border py-10 md:py-14">
        <Container>
          ...
          <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-[1fr_auto] md:items-end">
            ...
            <Link
              to="/cv"
              className="mono-type whitespace-nowrap text-foreground underline decoration-accent decoration-2 underline-offset-4 transition-colors hover:text-accent"
            >
              More about me →
            </Link>
          </div>
      ...
      <section className="border-b border-border py-10 md:py-14">
        <Container>
          ...
          <div className="mb-2 mt-6 flex justify-end">
            <Link
              to="/selected-works"
              className="mono-type text-accent transition-colors hover:text-foreground"
            >
              View all →
            </Link>
          </div>
